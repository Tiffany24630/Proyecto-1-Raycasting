...
pub const WINDOW_HEIGHT: usize = 700;
...
pub fn render_2d(framebuffer: &mut Framebuffer, maze: &Maze, player: &Player) {
    ...
    draw_player_2d(framebuffer, player);
...
pub fn draw_fps(framebuffer: &mut Framebuffer, fps: u32) {
    draw_rect(framebuffer, 12, 12, 120, 30, 0x101522);
...
fn draw_view_button(framebuffer: &mut Framebuffer) {
    ...
    draw_text(framebuffer, 1042, 648, "V / CLICK VISTA", 0xFFFFFF, 1);
}
...
fn draw_player_2d(framebuffer: &mut Framebuffer, player: &Player) {
